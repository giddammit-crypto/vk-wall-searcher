...
(function () {
    ...
    if (askForm && askInput && askLog && askSend) {
        ...
        var SYSTEM_PROMPT = [
            'Ты — Космо, дружелюбный робот-маскот сервиса AURORA для библиотек Владимира.',
            'Твоя специальность: анализ постов ВКонтакте, вовлеченность (ER), охваты, идеи контента и советы библиотекарям.',
            'Отвечай по-русски, тепло, грамотно, с легкой доброжелательной иронией, но строго по делу.',
