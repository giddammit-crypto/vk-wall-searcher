...
import { enrichTargetWithCanonical, renderBranchAvatarHtml, escapeHtml, findCanonicalBranch } from './branches.js?v=4.17.1';
import { extractNum, formatViews } from './analytics.js?v=4.17.1';
import { authorCache, getAuthorFromCache } from './api.js?v=4.17.1';
