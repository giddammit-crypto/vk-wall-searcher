...
import { enrichTargetWithCanonical, renderBranchAvatarHtml, escapeHtml, findCanonicalBranch } from './branches.js?v=4.18.3';
import { extractNum, formatViews } from './analytics.js?v=4.18.3';
import { authorCache, getAuthorFromCache } from './api.js?v=4.18.3';
