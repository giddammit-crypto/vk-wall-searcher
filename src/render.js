...
import { enrichTargetWithCanonical, renderBranchAvatarHtml, escapeHtml, findCanonicalBranch } from './branches.js?v=4.9.1';
import { extractNum, formatViews } from './analytics.js?v=4.9.1';
import { authorCache, getAuthorFromCache } from './api.js?v=4.9.1';
