...
import { enrichTargetWithCanonical, renderBranchAvatarHtml, escapeHtml, findCanonicalBranch } from './branches.js?v=3.7.4';
import { extractNum, formatViews } from './analytics.js?v=3.7.4';
import { authorCache, getAuthorFromCache } from './api.js?v=3.7.4';
