...
import { enrichTargetWithCanonical, renderBranchAvatarHtml, escapeHtml, findCanonicalBranch } from './branches.js?v=3.7.5';
import { extractNum, formatViews } from './analytics.js?v=3.7.5';
import { authorCache, getAuthorFromCache } from './api.js?v=3.7.5';
