...
import { callVkApi, resolveApiUrl } from './api.js?v=3.7.0';
import { CANONICAL_BRANCHES, escapeHtml, renderBranchAvatarHtml, findCanonicalBranch } from './branches.js?v=3.7.0';
import { makeTableSortable } from './tablesort.js?v=3.7.0';
...
export async function fetchHistory() {
    ...
    try {
        const staticRes = await fetch(resolveApiUrl('data/subscribers.json?v=3.7.0'));
