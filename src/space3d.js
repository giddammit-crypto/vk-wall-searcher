...
import { Constellations } from './constellations.js?v=4.21.0';
import { CosmonautsTerminal } from './cosmonauts_terminal.js?v=4.21.0';
...
import { PROMO_TEMPLATES, PROMO_SLOGANS, printPromoPoster } from './promo.js?v=4.24.0';
