...
export class Space3DGLRenderer {
    ...
    _textureSources() {
        return {
            earthDay: 'assets/textures/earth_day.jpg?v=4.21.0',
            earthNight: 'assets/textures/earth_night.png?v=4.21.0',
            earthClouds: 'assets/textures/earth_clouds.png?v=4.21.0',
            moon: 'assets/textures/moon.jpg?v=4.21.0'
        };
    }
