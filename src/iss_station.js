...
export const EARTH_CONFIG = {
    ...
    pitchDeg: -48,               // Возвышение центра Земли (занимает 80% нижней части экрана)
    dist: 980,                   // Расстояние до центра Земли от камеры (px, приближена еще в 2.5×)
    radius: 700,                 // Радиус физической сферы Земли (px, диаметр ~1530px)
...
export const ISS_CONFIG = {
    orbitAltitudePx: 60,         // Высота орбиты над поверхностью Земли (px)
    orbitRadiusPx: 760,          // 700 + 60 = 760 px от центра Земли
