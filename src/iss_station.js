...
export const EARTH_CONFIG = {
    ...
    pitchDeg: -12,               // Возвышение центра Земли (чуть ниже горизонта игрока)
    dist: 2454,                  // Расстояние до центра Земли от камеры (px, приближена в 0.8×)
    radius: 440,                 // Радиус физической сферы Земли (px)
    atmoRadius: 440 * 1.05,      // Внешний радиус атмосферного ореола
    axialTiltDeg: 23.44          // Наклон оси вращения Земли (градусы)
};

export const ISS_CONFIG = {
    orbitAltitudePx: 55,         // Высота орбиты над поверхностью Земли (px)
    orbitRadiusPx: 495,          // 440 + 55 = 495 px от центра Земли
    ...
    stationScale: 0.95,          // Масштабный коэффициент геометрии
