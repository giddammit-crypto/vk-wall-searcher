...
import { escapeHtml, declOfNum, findCanonicalBranch } from './branches.js?v=3.8.0';
import { resolveApiUrl } from './api.js?v=3.8.0';
import { resolveRepostAuthor } from './render.js?v=3.8.0';
