...
import { escapeHtml, declOfNum, findCanonicalBranch } from './branches.js?v=4.8.3';
import { resolveApiUrl } from './api.js?v=4.8.3';
import { resolveRepostAuthor } from './render.js?v=4.8.3';
