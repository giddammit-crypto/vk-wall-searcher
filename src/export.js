...
import { escapeHtml, declOfNum, findCanonicalBranch } from './branches.js?v=4.1.0';
import { resolveApiUrl } from './api.js?v=4.1.0';
import { resolveRepostAuthor } from './render.js?v=4.1.0';
