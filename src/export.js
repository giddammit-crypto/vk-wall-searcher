...
import { escapeHtml, declOfNum, findCanonicalBranch } from './branches.js?v=3.7.9';
import { resolveApiUrl } from './api.js?v=3.7.9';
import { resolveRepostAuthor } from './render.js?v=3.7.9';
