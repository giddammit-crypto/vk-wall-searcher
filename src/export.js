...
import { escapeHtml, declOfNum, findCanonicalBranch } from './branches.js?v=3.6.3';
import { resolveApiUrl } from './api.js?v=3.6.3';
import { resolveRepostAuthor } from './render.js?v=3.6.3';
