...
import { escapeHtml, declOfNum, findCanonicalBranch } from './branches.js?v=3.7.2';
import { resolveApiUrl } from './api.js?v=3.7.2';
import { resolveRepostAuthor } from './render.js?v=3.7.2';
