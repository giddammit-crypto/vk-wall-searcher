...
import { escapeHtml, declOfNum, findCanonicalBranch } from './branches.js?v=4.9.1';
import { resolveApiUrl } from './api.js?v=4.9.1';
import { resolveRepostAuthor } from './render.js?v=4.9.1';
