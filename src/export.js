...
import { escapeHtml, declOfNum, findCanonicalBranch } from './branches.js?v=3.7.1';
import { resolveApiUrl } from './api.js?v=3.7.1';
import { resolveRepostAuthor } from './render.js?v=3.7.1';
