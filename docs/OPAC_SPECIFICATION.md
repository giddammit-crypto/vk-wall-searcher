...
|---|---|---|---|---|---|:---:|:---:|
| **`аб`** | `ЦГБ-АБ`, `ФАБ` | Центральная городская библиотека, Абонемент | Суздальский пр-т, д. 2 | **жилой район «Доброе»** | 8(4922) 21-65-63, 21-66-80 | **ДА** | Нет |
| **`чз`** | `ЦГБ-ЧЗ` | Центральная городская библиотека, Читальный зал | Суздальский пр-т, д. 2 | **жилой район «Доброе»** | 8(4922) 21-65-63, 21-66-80 | **ДА** | Нет |
| **`до`** | `ЦГБ-ДО` | Центральная городская библиотека, Детский отдел | Суздальский пр-т, д. 2 | **жилой район «Доброе»** | 8(4922) 21-65-63 | **ДА** | Нет |
| **`кх`** | `ЦГБ-КХ` | Центральная городская библиотека, Книгохранилище | Суздальский пр-т, д. 2 | **жилой район «Доброе»** | 8(4922) 21-65-63 | **ДА** | Нет |
...
| **`ф1`** | `ЦГБ-Ф1` | Библиотека — филиал №1 | ул. Горького, д. 69 | Октябрьский / ВлГУ | 8(4922) 53-29-37 | Нет | Нет |
| **`ф2`** | `ЦГБ-Ф2`, `ф2д` (детский) | Библиотека — филиал №2 | пр-кт Ленина, д. 12 | Ленинский район | 8(4922) 38-34-47, 32-15-84 | Нет | Нет |
| **`ф3`** | `ЦГБ-Ф3`, `ф3сд` | Библиотека — филиал №3 | ул. Б. Нижегородская, д. 67а | Фрунзенский район | 8(4922) 32-36-74 | Нет | Нет |
| **`ф4`** | `ЦГБ-Ф4`, `ф4д` (детский) | Библиотека — филиал №4 | ул. Егорова, д. 10 | **жилой район «Доброе»** | 8(4922) 21-96-11, 21-23-48 | **ДА (КРИТИЧЕСКИ!)** | Нет |
| **`ф5`** | `ЦГБ-Ф5`, `ф5д` (детский) | Библиотека — филиал №5 | ул. Белоконской, д. 13а | Октябрьский район | 8(4922) 53-24-34 | Нет | Нет |
| **`ф6`** | `ЦГБ-Ф6` | Библиотека — филиал №6 | ул. Батурина, д. 28 | Октябрьский район | 8(4922) 33-37-00 | Нет | Нет |
| **`ф7`** | `ЦГБ-Ф7`, `ф7н`, `ф7нд` | Библиотека — филиал №7 | ул. Фатьянова, д. 14 | Юго-Западный (ЮЗР) | 8(4922) 38-26-88 | Нет | Нет |
| **`ф8`** | `ЦГБ-Ф8`, `ф8д` (детский) | Библиотека — филиал №8 | ул. Соколова-Соколенка, д. 17в | Фрунзенский район | 8(4922) 21-68-27 | Нет | Нет |
| **`ф9`** | `ЦГБ-Ф9` | Библиотека — филиал №9 («Добролит») | Добросельский проезд, д. 2 | **жилой район «Доброе»** | 8(4922) 21-58-15 | **ДА** | Нет |
| **`ф10`** | `ЦГБ-Ф10`, `ф10д` (детский) | Библиотека — филиал №10 | ул. Горького, д. 69 | Октябрьский / ВлГУ | 8(4922) 53-29-37 | Нет | Нет |
| **`ф11`** | `ЦГБ-Ф11`, `ф11д` (детский) | Библиотека — филиал №11 | ул. Мира, д. 90 | Октябрьский район | 8(4922) 53-39-80 | Нет | Нет |
| **`ф12`** | `ЦГБ-Ф12`, `ф12д` (детский) | Библиотека — филиал №12 | ул. Комиссарова, д. 28 | **жилой район «Доброе»** | 8(4922) 21-63-93 | **ДА** | Нет |
| **`ф13`** | `ЦГБ-Ф13`, `ф13н`, `ф13нд` | Библиотека — филиал №13 | ул. Верхняя Дуброва, д. 26г | Юго-Западный (ЮЗР) | 8(4922) 38-30-26 | Нет | Нет |
| **`ф14`** | `ЦГБ-Ф14`, `ф14н`, `ф14нд` | Библиотека — филиал №14 | ул. Добросельская, д. 161 | **жилой район «Доброе»** | 8(4922) 21-68-30 | **ДА** | Нет |
| **`ф15`** | `ЦГБ-Ф15`, `ф15н`, `ф15нд` | Библиотека — филиал №15 | ул. Юбилейная, д. 38 | **жилой район «Доброе»** | 8(4922) 21-13-05 | **ДА** | Нет |
...
- **Суффикс `н`** (например `ф7н`, `ф13н`, `ф14н`, `ф15н`): Модельная библиотека / новая площадка обслуживания после модернизации в рамках национального проекта «Культура».
- **Суффикс `нд`** (например `ф7нд`, `ф14нд`, `ф15нд`, `ф13нд`): Детское отделение модельной библиотеки.
...
3. **Все библиотеки района «Доброе»:**  
   ...
   - ЦГБ (Суздальский пр-т, 2): Абонемент (`аб`), Читальный зал (`чз`), Детский отдел (`до`), Книгохранилище (`кх`);
   - Филиал №4 (`ф4`, `ф4д`): ул. Егорова, 10;
   - Филиал №9 (`ф9`): Добросельский проезд, 2 («Добролит»);
   - Филиал №12 (`ф12`, `ф12д`): ул. Комиссарова, 28;
   - Филиал №14 (`ф14`, `ф14н`, `ф14нд`): ул. Добросельская, 161;
   - Филиал №15 (`ф15`, `ф15н`, `ф15нд`): ул. Юбилейная, 38.
...
def normalize_sigla(raw_sigla: str) -> str:
    ...
    # 2. Прямое сопоставление базовых отделов ЦГБ
    if s in ['аб', 'фаб']: return 'аб'
    if s in ['чз']: return 'чз'
    if s in ['до']: return 'до'
    if s in ['кх']: return 'кх'
    if s in ['цдб', 'цдч', 'цди', 'цки']: return 'цдб'
