...
export const BLOCK_PALETTE = [
  ...
  { cat: 'layout', id: 'container', icon: 'crop_free', label: 'Контейнер',
    html: `<div class="ve-container" style="max-width:1100px;margin:0 auto;padding:24px 16px;">
  <!-- Ваш контент -->
</div>` },
  { cat: 'layout', id: 'section', icon: 'view_agenda', label: 'Секция',
    html: `<section class="ve-section" style="padding:60px 16px;background:#f8f9fa;">
  <div style="max-width:1100px;margin:0 auto;"><!-- Секция --></div>
</section>` },
  { cat: 'layout', id: 'row2', icon: 'view_column', label: '2 колонки',
    html: `<div class="ve-row" style="display:grid;grid-template-columns:1fr 1fr;gap:24px;padding:16px;">
  <div style="padding:16px;background:#fff;border-radius:8px;">Колонка 1</div>
  <div style="padding:16px;background:#fff;border-radius:8px;">Колонка 2</div>
</div>` },
  { cat: 'layout', id: 'row3', icon: 'grid_on', label: '3 колонки',
    html: `<div class="ve-row" style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:24px;padding:16px;">
  <div style="padding:16px;background:#fff;border-radius:8px;">Колонка 1</div>
  <div style="padding:16px;background:#fff;border-radius:8px;">Колонка 2</div>
  <div style="padding:16px;background:#fff;border-radius:8px;">Колонка 3</div>
</div>` },
  { cat: 'layout', id: 'spacer', icon: 'height', label: 'Отступ',
    html: `<div class="ve-spacer" style="height:48px;"></div>` },
  { cat: 'layout', id: 'divider', icon: 'horizontal_rule', label: 'Разделитель',
    html: `<hr class="ve-divider" style="border:none;border-top:2px solid #e2e8f0;margin:24px 0;">` },

  // Typography
  { cat: 'text', id: 'h1', icon: 'format_h1', label: 'Заголовок H1',
    html: `<h1 style="font-size:48px;font-weight:800;color:#1a202c;margin:0 0 16px;line-height:1.2;">Заголовок первого уровня</h1>` },
  { cat: 'text', id: 'h2', icon: 'format_h2', label: 'Заголовок H2',
    html: `<h2 style="font-size:36px;font-weight:700;color:#2d3748;margin:0 0 14px;line-height:1.3;">Заголовок второго уровня</h2>` },
  { cat: 'text', id: 'h3', icon: 'format_h3', label: 'Заголовок H3',
    html: `<h3 style="font-size:26px;font-weight:600;color:#4a5568;margin:0 0 12px;">Заголовок третьего уровня</h3>` },
  { cat: 'text', id: 'paragraph', icon: 'notes', label: 'Параграф',
    html: `<p style="font-size:16px;line-height:1.7;color:#4a5568;margin:0 0 16px;">Введите текст параграфа. Здесь может быть любое описание, информационный блок или контентный текст вашей страницы.</p>` },
  { cat: 'text', id: 'lead', icon: 'format_size', label: 'Lead-текст',
    html: `<p style="font-size:20px;line-height:1.6;color:#718096;margin:0 0 24px;font-weight:400;">Крупный вступительный текст, который привлекает внимание.</p>` },
  { cat: 'text', id: 'quote', icon: 'format_quote', label: 'Цитата',
    html: `<blockquote style="border-left:4px solid #6366f1;padding:16px 24px;margin:24px 0;background:#f5f3ff;border-radius:0 8px 8px 0;font-style:italic;color:#4c1d95;">
  ...
  { cat: 'text', id: 'code', icon: 'code', label: 'Блок кода',
    html: `<pre style="background:#1e293b;color:#e2e8f0;padding:20px 24px;border-radius:10px;overflow-x:auto;font-family:'JetBrains Mono',monospace;font-size:14px;margin:16px 0;"><code>// Ваш код здесь
console.log("Hello, World!");</code></pre>` },
  { cat: 'text', id: 'list', icon: 'format_list_bulleted', label: 'Список',
    html: `<ul style="padding-left:24px;margin:16px 0;color:#4a5568;line-height:1.8;">
  ...
  <img src="https://placehold.co/800x400/6366f1/fff?text=Изображение" alt="Описание" style="width:100%;max-width:800px;border-radius:12px;display:block;margin:0 auto;">
  ...
  { cat: 'media', id: 'avatar', icon: 'account_circle', label: 'Аватар + имя',
    html: `<div style="display:flex;align-items:center;gap:14px;padding:16px;">
  <img src="https://placehold.co/56x56/6366f1/fff?text=АВ" alt="Аватар" style="width:56px;height:56px;border-radius:50%;object-fit:cover;">
  <div>
  ...
  { cat: 'media', id: 'youtube', icon: 'smart_display', label: 'YouTube',
    html: `<div style="position:relative;padding-top:56.25%;border-radius:12px;overflow:hidden;margin:16px 0;">
  ...
  { cat: 'components', id: 'hero', icon: 'view_carousel', label: 'Hero секция',
    html: `<section style="padding:80px 16px;text-align:center;background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);color:#fff;">
  <h1 style="font-size:52px;font-weight:800;margin:0 0 20px;line-height:1.15;">Ваш главный заголовок</h1>
  <p style="font-size:20px;opacity:.85;margin:0 0 36px;max-width:600px;margin-left:auto;margin-right:auto;">Краткое и ёмкое описание вашего продукта или услуги</p>
  <div style="display:flex;gap:16px;justify-content:center;flex-wrap:wrap;">
    <a href="#" style="background:#fff;color:#667eea;padding:14px 32px;border-radius:50px;font-weight:700;text-decoration:none;font-size:16px;">Начать →</a>
    <a href="#" style="border:2px solid rgba(255,255,255,.7);color:#fff;padding:14px 32px;border-radius:50px;font-weight:600;text-decoration:none;font-size:16px;">Узнать больше</a>
  </div>
</section>` },
  { cat: 'components', id: 'button', icon: 'smart_button', label: 'Кнопка',
    html: `<div style="padding:8px 0;">
  <a href="#" style="display:inline-block;background:#6366f1;color:#fff;padding:14px 32px;border-radius:8px;font-weight:600;text-decoration:none;font-size:16px;transition:opacity .2s;">Нажмите меня</a>
</div>` },
  { cat: 'components', id: 'button-outline', icon: 'radio_button_unchecked', label: 'Кнопка (контур)',
    html: `<div style="padding:8px 0;">
  <a href="#" style="display:inline-block;border:2px solid #6366f1;color:#6366f1;padding:12px 30px;border-radius:8px;font-weight:600;text-decoration:none;font-size:16px;">Контурная кнопка</a>
</div>` },
  { cat: 'components', id: 'card', icon: 'credit_card', label: 'Карточка',
    html: `<div style="background:#fff;border-radius:16px;box-shadow:0 4px 24px rgba(0,0,0,.08);overflow:hidden;max-width:360px;">
  <img src="https://placehold.co/360x200/6366f1/fff?text=Карточка" style="width:100%;display:block;">
  <div style="padding:24px;">
    <h3 style="margin:0 0 8px;font-size:20px;font-weight:700;color:#1a202c;">Название карточки</h3>
    <p style="margin:0 0 20px;color:#718096;line-height:1.6;">Краткое описание контента карточки. Может быть несколько строк.</p>
    <a href="#" style="display:inline-block;background:#6366f1;color:#fff;padding:10px 24px;border-radius:8px;font-weight:600;text-decoration:none;font-size:14px;">Подробнее</a>
  </div>
</div>` },
  ...
  { cat: 'components', id: 'alert', icon: 'info', label: 'Уведомление',
    html: `<div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:10px;padding:16px 20px;display:flex;gap:12px;align-items:flex-start;margin:12px 0;">
  <span style="font-size:20px;">ℹ️</span>
  <div>
    <strong style="color:#1e40af;display:block;margin-bottom:4px;">Заголовок уведомления</strong>
  ...
  { cat: 'components', id: 'navbar', icon: 'menu', label: 'Навбар',
    html: `<nav style="background:#fff;padding:0 24px;display:flex;align-items:center;justify-content:space-between;height:64px;box-shadow:0 1px 3px rgba(0,0,0,.1);">
  <a href="#" style="font-weight:800;font-size:20px;color:#6366f1;text-decoration:none;">🅰 Логотип</a>
  <div style="display:flex;gap:24px;">
    <a href="#" style="color:#4a5568;text-decoration:none;font-weight:500;">Главная</a>
    <a href="#" style="color:#4a5568;text-decoration:none;font-weight:500;">О нас</a>
    <a href="#" style="color:#4a5568;text-decoration:none;font-weight:500;">Контакты</a>
  </div>
  <a href="#" style="background:#6366f1;color:#fff;padding:8px 20px;border-radius:8px;text-decoration:none;font-weight:600;font-size:14px;">Войти</a>
</nav>` },
  { cat: 'components', id: 'pricing', icon: 'payments', label: 'Pricing Card',
    html: `<div style="background:#fff;border-radius:20px;border:2px solid #6366f1;padding:36px 28px;max-width:320px;text-align:center;box-shadow:0 8px 32px rgba(99,102,241,.15);">
  <div style="background:#ede9fe;color:#7c3aed;font-size:13px;font-weight:700;padding:4px 14px;border-radius:20px;display:inline-block;margin-bottom:16px;">⭐ Популярный</div>
  <h3 style="font-size:22px;font-weight:700;color:#1a202c;margin:0 0 8px;">Pro план</h3>
  <div style="font-size:48px;font-weight:800;color:#6366f1;margin:16px 0;"><sup style="font-size:24px;">₽</sup>990<sub style="font-size:16px;color:#718096;">/мес</sub></div>
  <ul style="list-style:none;padding:0;margin:0 0 28px;color:#4a5568;text-align:left;line-height:2;">
    <li>✅ Функция первая</li>
    <li>✅ Функция вторая</li>
    <li>✅ Функция третья</li>
    <li>✅ Приоритетная поддержка</li>
  </ul>
  <a href="#" style="display:block;background:#6366f1;color:#fff;padding:14px;border-radius:10px;font-weight:700;text-decoration:none;">Выбрать план</a>
</div>` },
  { cat: 'components', id: 'footer', icon: 'web_asset', label: 'Footer',
    html: `<footer style="background:#1e293b;color:#94a3b8;padding:40px 24px;text-align:center;">
  <div style="font-size:20px;font-weight:700;color:#fff;margin-bottom:12px;">🅰 Ваш бренд</div>
  ...
  <div style="font-size:13px;border-top:1px solid #334155;padding-top:16px;margin-top:8px;">© 2024 Все права защищены</div>
</footer>` },

  // Forms
  { cat: 'forms', id: 'form-contact', icon: 'contact_mail', label: 'Форма обратной связи',
    html: `<form style="background:#fff;padding:32px;border-radius:16px;box-shadow:0 4px 24px rgba(0,0,0,.08);max-width:480px;" onsubmit="return false">
  <h3 style="margin:0 0 24px;font-size:22px;font-weight:700;color:#1a202c;">Напишите нам</h3>
  <div style="margin-bottom:16px;">
    <label style="display:block;margin-bottom:6px;font-size:14px;font-weight:600;color:#374151;">Имя</label>
    <input type="text" placeholder="Ваше имя" style="width:100%;padding:10px 14px;border:1.5px solid #e2e8f0;border-radius:8px;font-size:16px;box-sizing:border-box;outline:none;transition:border .2s;">
  </div>
  <div style="margin-bottom:16px;">
    <label style="display:block;margin-bottom:6px;font-size:14px;font-weight:600;color:#374151;">Email</label>
    <input type="email" placeholder="email@example.com" style="width:100%;padding:10px 14px;border:1.5px solid #e2e8f0;border-radius:8px;font-size:16px;box-sizing:border-box;outline:none;">
  </div>
  <div style="margin-bottom:20px;">
    <label style="display:block;margin-bottom:6px;font-size:14px;font-weight:600;color:#374151;">Сообщение</label>
    <textarea rows="4" placeholder="Ваше сообщение..." style="width:100%;padding:10px 14px;border:1.5px solid #e2e8f0;border-radius:8px;font-size:16px;box-sizing:border-box;resize:vertical;outline:none;"></textarea>
  </div>
  <button type="submit" style="width:100%;background:#6366f1;color:#fff;padding:12px;border:none;border-radius:8px;font-size:16px;font-weight:700;cursor:pointer;">Отправить →</button>
</form>` },
  ...
  <input type="text" placeholder="Введите значение..." style="width:100%;padding:10px 14px;border:1.5px solid #e2e8f0;border-radius:8px;font-size:16px;box-sizing:border-box;background:#fff;">
</div>` },
  ...
  <textarea rows="4" placeholder="Введите текст..." style="width:100%;padding:10px 14px;border:1.5px solid #e2e8f0;border-radius:8px;font-size:16px;box-sizing:border-box;resize:vertical;background:#fff;"></textarea>
</div>` },
  { cat: 'forms', id: 'checkbox', icon: 'check_box', label: 'Чекбокс',
    html: `<label style="display:flex;align-items:center;gap:10px;cursor:pointer;color:#374151;font-size:15px;margin:8px 0;">
  ...
  <select style="width:100%;padding:10px 14px;border:1.5px solid #e2e8f0;border-radius:8px;font-size:16px;background:#fff;cursor:pointer;">
  ...
  { cat: 'anim', id: 'anim-fadein', icon: 'animation', label: 'Fade In',
    html: `<div style="animation:fadeIn 1s ease-in-out;padding:20px;background:#f0fdf4;border-radius:12px;text-align:center;border:2px dashed #86efac;">
  <style>@keyframes fadeIn{from{opacity:0}to{opacity:1}}</style>
  ✨ Этот блок появляется плавно (Fade In)
</div>` },
  { cat: 'anim', id: 'anim-slideup', icon: 'arrow_upward', label: 'Slide Up',
    html: `<div style="animation:slideUp .7s cubic-bezier(.22,.61,.36,1);padding:20px;background:#fefce8;border-radius:12px;text-align:center;border:2px dashed #fde047;">
  <style>@keyframes slideUp{from{opacity:0;transform:translateY(40px)}to{opacity:1;transform:translateY(0)}}</style>
  🚀 Этот блок всплывает снизу (Slide Up)
</div>` },
  { cat: 'anim', id: 'anim-pulse', icon: 'favorite', label: 'Pulse',
    html: `<div style="animation:pulse 1.5s ease-in-out infinite;display:inline-block;padding:16px 32px;background:#fce7f3;border-radius:50px;color:#db2777;font-weight:700;border:2px solid #f9a8d4;">
  <style>@keyframes pulse{0%,100%{transform:scale(1)}50%{transform:scale(1.05)}}</style>
  💓 Pulsing блок
</div>` },
  { cat: 'anim', id: 'anim-neon', icon: 'bolt', label: 'Neon Glow',
    html: `<div style="padding:20px;text-align:center;background:#0f172a;border-radius:12px;">
  ...
  <span style="font-size:32px;font-weight:800;color:#a78bfa;animation:neonPulse 2s ease-in-out infinite;">⚡ NEON GLOW</span>
</div>` },
];
...
export class VisualEditor {
  ...
  _bindBlockEvents(wrapper, def) {
    ...
    wrapper.addEventListener('click', e => {
      if (e.target.closest('.ve-act-btn')) return;
      e.stopPropagation();
      this._select(wrapper, def);
    });
  ...
  _buildStyleProps(wrapper) {
    const style = wrapper.querySelector('.ve-block-content')?.style || {};
    return `
      <div class="ve-prop-row">
        <label>Фон</label>
        <input type="color" class="ve-color-pick" data-prop="background" value="${this._colorToHex(wrapper.querySelector('.ve-block-content').style.background) || '#ffffff'}">
      </div>
      <div class="ve-prop-row">
        <label>Цвет текста</label>
        <input type="color" class="ve-color-pick" data-prop="color" value="${this._colorToHex(wrapper.querySelector('.ve-block-content').style.color) || '#000000'}">
      </div>
      <div class="ve-prop-row">
        <label>Padding (px)</label>
        <input type="number" class="ve-num-input" data-prop="padding" value="${parseInt(wrapper.querySelector('.ve-block-content').style.padding) || 0}" min="0" max="200">
      </div>
      <div class="ve-prop-row">
        <label>Border radius</label>
        <input type="number" class="ve-num-input" data-prop="borderRadius" value="${parseInt(wrapper.querySelector('.ve-block-content').style.borderRadius) || 0}" min="0" max="100">
      </div>
      <div class="ve-prop-row">
        <label>Отступ сверху</label>
        <input type="number" class="ve-num-input" data-prop="marginTop" value="${parseInt(wrapper.querySelector('.ve-block-content').style.marginTop) || 0}" min="0" max="200">
      </div>
      <div class="ve-prop-row">
        <label>Отступ снизу</label>
        <input type="number" class="ve-num-input" data-prop="marginBottom" value="${parseInt(wrapper.querySelector('.ve-block-content').style.marginBottom) || 0}" min="0" max="200">
      </div>`;
  }
  ...
  _bindPropsEvents(wrapper, content) {
    ...
    p.querySelectorAll('.ve-num-input[data-styleprop]').forEach(input => {
      input.addEventListener('input', () => {
        ...
        const target = content.querySelector('h1,h2,h3,h4,p,span,a') || content;
        target.style[input.dataset.styleprop] = val;
      });
      input.addEventListener('change', () => this._saveHistory());
    });

    // Text align buttons
    p.querySelectorAll('.ve-align-btns button').forEach(btn => {
      btn.addEventListener('click', () => {
        const target = content.querySelector('h1,h2,h3,h4,p,span,a,div') || content;
        target.style.textAlign = btn.dataset.val;
        p.querySelectorAll('.ve-align-btns button').forEach(b => b.classList.remove('is-active'));
